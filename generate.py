  ...
  <style>
    ...
    *,*::before,*::after{margin:0;padding:0;box-sizing:border-box}
    ...
    [data-theme="strategist"]{
      --bg:#030a06;--s1:#07140c;--s2:#0c1e12;--s3:#112819;
      --border:#183322;--bl:#245c38;
      --purple:#a3e635;--pl:#bef264;--pdim:rgba(163,230,53,.1);
      --green:#4ade80;--gdim:rgba(74,222,128,.1);
      --yellow:#86efac;--ydim:rgba(134,239,172,.1);
      --blue:#34d399;--bdim:rgba(52,211,153,.1);
      --teal:#2dd4bf;
      --text:#d1fae5;--td:#6ee7b7;--tm:#34d399;
    }
    [data-theme="investor"]{
      --bg:#060408;--s1:#0e0a14;--s2:#140e1e;--s3:#1a1228;
      --border:#241a34;--bl:#382650;
      --purple:#a855f7;--pl:#c084fc;--pdim:rgba(168,85,247,.12);
      --green:#4ade80;--gdim:rgba(74,222,128,.08);
      --yellow:#c084fc;--ydim:rgba(192,132,252,.1);
      --blue:#8b5cf6;--bdim:rgba(139,92,246,.1);
      --teal:#a78bfa;
      --text:#ede9fe;--td:#c4b5fd;--tm:#8b5cf6;
    }

    /* ── Per-theme Hero backgrounds (override photo for non-commander) ── */
    ...
    [data-theme="architect"] .hero{
      background:
        ...
        radial-gradient(ellipse at 90% 90%, rgba(85,170,255,.07) 0%, transparent 28%),
        radial-gradient(ellipse at 10% 10%, rgba(55,119,238,.05) 0%, transparent 25%),
        #010408;
    ...
    [data-theme="strategist"] .hero{
      background:
        radial-gradient(ellipse at 66% 36%, rgba(74,222,128,.20) 0%, transparent 54%),
        radial-gradient(ellipse at 90% 90%, rgba(34,197,94,.07) 0%, transparent 28%),
        radial-gradient(ellipse at 10% 10%, rgba(16,185,129,.05) 0%, transparent 25%),
        #010803;
      border-color:rgba(74,222,128,.22)}
    [data-theme="strategist"] .hero::before{
      background:linear-gradient(90deg,transparent,rgba(74,222,128,.7),rgba(52,211,153,.5),transparent)}
    ...
    [data-theme="investor"] .hero{
      background:
        radial-gradient(ellipse at 66% 34%, rgba(168,85,247,.28) 0%, transparent 52%),
        radial-gradient(ellipse at 88% 88%, rgba(139,92,246,.10) 0%, transparent 30%),
        radial-gradient(ellipse at 12% 12%, rgba(109,40,217,.08) 0%, transparent 28%),
        #060408;
      border-color:rgba(168,85,247,.28)}
    [data-theme="investor"] .hero::before{
      background:linear-gradient(90deg,transparent,rgba(168,85,247,.7),rgba(192,132,252,.5),transparent)}
    [data-theme="investor"] .hero::after{
      background:linear-gradient(90deg,transparent,rgba(168,85,247,.05),transparent)}
    [data-theme="investor"] .hero-metric{border-color:rgba(168,85,247,.18)}
    [data-theme="investor"] .hm-value{color:var(--pl)}
    [data-theme="investor"] .hm-ai .hm-value{color:var(--green)}
    [data-theme="investor"] .roi-box{border-color:rgba(168,85,247,.22)}
    ...
    [data-theme="investor"] .fin-val{color:var(--pl)}
    [data-theme="investor"] .pj-metric{color:var(--pl)}
    [data-theme="investor"] .focus-num{color:var(--pl)}
    ...
    <div class="hero-meta-wrap">
      ...
      <div class="th-wrap">
        ...
        <div class="theme-switcher">
          ...
          <button class="th-btn" data-theme="strategist" title="駿馬ターミナル">💻</button>
          <button class="th-btn" data-theme="investor" title="覇者モード">👑</button>
        </div>
      </div>
    </div>
  </div>
...
<script>
  ...
  // Tab switcher (3 tabs: kpi / biz / dec)
  (function(){
    function switchTab(t){
      if(!['kpi','biz','dec'].includes(t)) t='kpi';
