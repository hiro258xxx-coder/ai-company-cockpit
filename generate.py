...
<head>
  ...
  <style>
    ...
    *,*::before,*::after{margin:0;padding:0;box-sizing:border-box}
    ...
    .hero-right{width:248px;flex-shrink:0;display:flex;align-items:flex-end;justify-content:flex-end;overflow:hidden}
    .boss-svg{width:248px;height:auto;filter:drop-shadow(0 0 20px var(--blue));opacity:.9;display:block}
    [data-theme="strategist"] .boss-svg{filter:drop-shadow(0 0 10px rgba(26,80,138,.35));opacity:.82}
...
<div class="hero fade-in">
  ...
  <div class="hero-body">
    ...
    <!-- Boss character SVG (CSS-variable themed) -->
    <div class="hero-right">
      <svg class="boss-svg" viewBox="0 0 248 362" xmlns="http://www.w3.org/2000/svg" fill="none">
        <!-- Ambient floor glow -->
        <ellipse cx="124" cy="340" rx="84" ry="22" fill="var(--blue)" opacity="0.08"/>
        <!-- ── DATA SCREENS ── -->
        <!-- Left panel: bar chart -->
        <rect x="6" y="44" width="66" height="78" rx="4" fill="var(--s2)" stroke="var(--blue)" stroke-width="0.9" opacity="0.8"/>
        <rect x="14" y="53" width="42" height="4" rx="2" fill="var(--blue)" opacity="0.6"/>
        <rect x="14" y="60" width="28" height="3" rx="1.5" fill="var(--blue)" opacity="0.3"/>
        <rect x="14" y="65" width="36" height="3" rx="1.5" fill="var(--blue)" opacity="0.22"/>
        <rect x="14" y="94" width="8" height="20" rx="1" fill="var(--blue)" opacity="0.4"/>
        <rect x="25" y="85" width="8" height="29" rx="1" fill="var(--blue)" opacity="0.55"/>
        <rect x="36" y="89" width="8" height="25" rx="1" fill="var(--blue)" opacity="0.72"/>
        <rect x="47" y="77" width="8" height="37" rx="1" fill="var(--blue)" opacity="0.9"/>
        <!-- Center main screen: line chart -->
        <rect x="84" y="12" width="108" height="86" rx="6" fill="var(--s2)" stroke="var(--blue)" stroke-width="1.3"/>
        <rect x="84" y="12" width="108" height="86" rx="6" fill="var(--bdim)" opacity="0.55"/>
        <polyline points="96,78 113,62 130,70 147,47 164,54 180,41" stroke="var(--blue)" stroke-width="2.2" fill="none" opacity="0.9" stroke-linecap="round" stroke-linejoin="round"/>
        <polyline points="96,86 96,78 113,62 130,70 147,47 164,54 180,41 180,86" fill="var(--blue)" opacity="0.07"/>
        <rect x="95" y="23" width="46" height="5" rx="2.5" fill="var(--blue)" opacity="0.65"/>
        <rect x="95" y="32" width="32" height="3" rx="1.5" fill="var(--blue)" opacity="0.3"/>
        <circle cx="169" cy="25" r="3" fill="var(--green)" opacity="0.9"/>
        <circle cx="177" cy="25" r="3" fill="var(--yellow)" opacity="0.7"/>
        <circle cx="185" cy="25" r="3" fill="var(--blue)" opacity="0.5"/>
        <!-- Right panel: donut chart -->
        <rect x="182" y="52" width="60" height="76" rx="4" fill="var(--s2)" stroke="var(--blue)" stroke-width="0.9" opacity="0.8"/>
        <circle cx="212" cy="97" r="22" fill="none" stroke="var(--s3)" stroke-width="10"/>
        <circle cx="212" cy="97" r="22" fill="none" stroke="var(--blue)" stroke-width="10" stroke-dasharray="46,92" stroke-dashoffset="8" opacity="0.85"/>
        <circle cx="212" cy="97" r="22" fill="none" stroke="var(--green)" stroke-width="10" stroke-dasharray="28,110" stroke-dashoffset="54" opacity="0.75"/>
        <circle cx="212" cy="97" r="22" fill="none" stroke="var(--yellow)" stroke-width="10" stroke-dasharray="18,120" stroke-dashoffset="82" opacity="0.65"/>
        <circle cx="212" cy="97" r="8" fill="var(--s2)"/>
        <!-- Dashed connector lines -->
        <line x1="40" y1="102" x2="68" y2="135" stroke="var(--blue)" stroke-width="0.8" stroke-dasharray="4,3" opacity="0.3"/>
        <line x1="140" y1="98" x2="182" y2="115" stroke="var(--blue)" stroke-width="0.8" stroke-dasharray="4,3" opacity="0.3"/>
        <!-- ── BOSS FIGURE ── -->
        <!-- Head -->
        <circle cx="124" cy="183" r="30" fill="var(--s1)" stroke="var(--blue)" stroke-width="1.8"/>
        <!-- Eyes (alert, confident look) -->
        <ellipse cx="114" cy="178" rx="4" ry="4.5" fill="var(--blue)" opacity="0.82"/>
        <ellipse cx="134" cy="178" rx="4" ry="4.5" fill="var(--blue)" opacity="0.82"/>
        <!-- Confident smile -->
        <path d="M116,193 Q124,200 132,193" stroke="var(--blue)" stroke-width="1.8" fill="none" opacity="0.65" stroke-linecap="round"/>
        <!-- Neck -->
        <rect x="117" y="211" width="14" height="12" rx="2" fill="var(--s1)" stroke="var(--blue)" stroke-width="1.5"/>
        <!-- Suit jacket left -->
        <path d="M62,226 Q84,215 117,224 L113,336 L62,336 Z" fill="var(--s1)" stroke="var(--blue)" stroke-width="1.5"/>
        <!-- Suit jacket right -->
        <path d="M131,224 Q164,215 186,226 L186,336 L135,336 Z" fill="var(--s1)" stroke="var(--blue)" stroke-width="1.5"/>
        <!-- Shirt / lapels -->
        <path d="M117,224 L124,252 L131,224" fill="var(--s2)" stroke="var(--blue)" stroke-width="1" opacity="0.85"/>
        <!-- Tie -->
        <path d="M120,252 L128,252 L126,314 L124,320 L122,314 Z" fill="var(--bdim)" stroke="var(--blue)" stroke-width="0.9" opacity="0.9"/>
        <!-- Left arm → pointing at left panel -->
        <path d="M65,244 Q39,215 30,136" stroke="var(--blue)" stroke-width="3" fill="none" stroke-linecap="round" stroke-linejoin="round"/>
        <circle cx="29" cy="132" r="5" fill="var(--blue)" opacity="0.9"/>
        <line x1="29" y1="132" x2="20" y2="120" stroke="var(--blue)" stroke-width="2.2" stroke-linecap="round"/>
        <!-- Right arm → pointing at right panel -->
        <path d="M183,242 Q210,212 214,138" stroke="var(--blue)" stroke-width="3" fill="none" stroke-linecap="round" stroke-linejoin="round"/>
        <circle cx="214" cy="134" r="5" fill="var(--blue)" opacity="0.9"/>
        <line x1="214" y1="134" x2="222" y2="122" stroke="var(--blue)" stroke-width="2.2" stroke-linecap="round"/>
        <!-- Floating data particles -->
        <circle cx="14" cy="170" r="3" fill="var(--blue)" opacity="0.5"/>
        <circle cx="8"  cy="198" r="1.8" fill="var(--blue)" opacity="0.3"/>
        <circle cx="22" cy="222" r="2.2" fill="var(--blue)" opacity="0.38"/>
        <circle cx="228" cy="172" r="3" fill="var(--blue)" opacity="0.5"/>
        <circle cx="238" cy="200" r="1.8" fill="var(--blue)" opacity="0.3"/>
        <circle cx="232" cy="226" r="2.2" fill="var(--blue)" opacity="0.38"/>
      </svg>
    </div>
  </div>
</div>
